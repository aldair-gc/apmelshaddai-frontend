...
import { MapSquare, SquareBox, SquareButton, SquareContainer } from "./style";
          ...
          <div className="inner-square" id="adress-square">
            <div className="square-general">
              ...
              <div className="square-buttons">
                <SquareButton href="https://www.google.com/maps/dir//Apostolic+and+Prophetic+Ministries+El+Shaddai,+125+Rollstone+St,+Fitchburg,+MA+01420,+United+States/@42.5825698,-71.8095195,17z/data=!4m8!4m7!1m0!1m5!1m1!1s0x89e3e657847c3ead:0x28e614e0dae2564!2m2!1d-71.8072579!2d42.5825431">
                  <h2>
                    <i className="fa-solid fa-compass"></i> Get directions
                  </h2>
                </SquareButton>
              </div>
            </div>
          ...
          <div className="inner-square" id="phone-and-email">
            <div className="square-general" id="phone-email-square">
              ...
              <div className="text-center">
                <h3>
                  <i className="fa-solid fa-phone"></i> 1774-204-1359
                </h3>
                <h3>
              ...
              <div className="square-buttons">
                <SquareButton href="tel:1774-204-1359">
                  <h2>
                    <i className="fa-solid fa-phone"></i> Call
                  </h2>
                </SquareButton>
                <SquareButton href="https://wa.me/17742041359">
                  <h2>
                    <i className="fa-brands fa-whatsapp"></i> Whatsapp
                  </h2>
                </SquareButton>
                <SquareButton href="mailto:email@email.com">
                  <h2>
